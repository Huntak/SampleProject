...
dhtmlXGridCellObject.prototype.setCValue = function(a, b) {
    ...
    this.grid.callEvent("onCellChanged", [this.cell.parentNode.idd, this.cell._cellIndex, arguments.length > 1 ? b : a])
};
...
function eXcell_edn(a) {
    if (a) this.cell = a, this.grid = this.cell.parentNode.grid;
    this.getValue = function() {
        return this.cell.firstChild && this.cell.firstChild.tagName == "TEXTAREA" ? this.cell.firstChild.value : this.cell._clearCell ? "" : this.cell._orig_value || this.grid._aplNFb(this.cell.innerHTML.toString()._dhx_trim(), this.cell._cellIndex)
    };
    this.detach = function() {
...
eXcell_edn.prototype.setValue = function(a) {
    if (!a || a.toString()._dhx_trim() == "") return this.cell._clearCell = !0, this.setCValue("&nbsp;", 0);
    else this.cell._clearCell = !1, this.cell._orig_value = a;
